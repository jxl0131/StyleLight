...
if False:
    ...
    image_paths = glob.glob('/data/jixinlong/jixinlong/datasets/web_hdris_indoor/pana_rotate/*exr')
    to_path_warp = '/data/jixinlong/jixinlong/datasets/web_hdris_indoor/warped'
...
# image_paths = ['/data/jixinlong/jixinlong/datasets/web_hdris_indoor/pana_rotate/abandoned_greenhouse_0.exr']
for image_path in image_paths:
    env = EnvironmentMap(image_path, 'latlong')
    env.data = cv2.resize(env.data, (256,128))
    ...
    imsave(image_warp_name, warp_image[:,:,:3]) 
